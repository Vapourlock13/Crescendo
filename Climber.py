...
MAX_EXTENSION_ENCODER_VALUE = -787000
...
def climb(left_speed: float, right_speed: float) -> float:
...
def unsafe_climb(left_speed: float, right_speed: float) -> float:
    left_climb_motor.set(left_speed * 0.1)
    # right_climb_motor.set(right_speed * 0.1)
